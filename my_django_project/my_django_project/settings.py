...
SECRET_KEY = "django-insecure-=vcn$m0f7-%i#)8qg6b+r=#$imfm(+#4tyt0*lr*q4&mr#f5&h"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["10.0.0.173", "10.0.0.58", "10.0.0.173:8000", "10.0.0.103", "127.0.0.1", "localhost"]
